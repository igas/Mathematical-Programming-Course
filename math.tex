...
\{СХЕМА!\}
  ...
  \begin{tikzpicture}[scale=1.5]
    ...
    \draw (one) -- +(60:2) coordinate(n plus 1) node[above right]{$n+1$} -- (n);   
    \coordinate (1 stroke) at ($ (one)!.25!(n plus 1) $) (1 stroke) node[below right]{$1'$};
    \coordinate (n stroke) at ($ (n)!.25!(n plus 1)$) (n stroke) node[above left]{$n'$};
    \draw (1 stroke) -- (n stroke) -- +(60:1.5) node[above]{$n+2$} -- (n plus 1);
  ...
  \begin{tikzpicture}[scale=1.5]
    \draw (0,0) node[below left]{0} -- +(60:2) coordinate (n) node[above left]{$n$} -- +(0:2) coordinate (one) node[below right]{1}  -- (0,0);
    \draw (one) -- +(60:2) coordinate(n plus 1) node[below right]{$n+1$} -- (n);    
    \coordinate (1 stroke) at ($ (one)!.25!(n) $) (1 stroke) node[below left]{$1'$};
    \coordinate (n plus 1 stroke) at ($ (n plus 1)!.25!(n) $) (n plus 1 stroke) node[above right]{$n+1'$};
    \draw (1 stroke) -- (n plus 1 stroke) -- +(120:1.5) node[above]{$n+2$} -- (n);
  \end{tikzpicture}
